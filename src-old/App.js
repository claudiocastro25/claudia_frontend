...
import ClaudiaBrandGuidelines from './components/layout/ClaudiaBrandGuidelines';
...
// Componente para redirecionamento inteligente com base na autenticação
const RootRedirect = () => {
        ...
        <VisualizationProvider>
          <Router>
            <Routes>
              ...
              <Route path="/brand-guidelines" element={<ClaudiaBrandGuidelines />} />
              ...
              {/* Redirecionamento padrão com base na autenticação */}
              <Route path="/" element={<RootRedirect />} />
              
              {/* Capturar rotas não encontradas e redirecionar */}
